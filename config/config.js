...
var home = process.env.INSIGHT_DB || (getUserHome() + '/.insight-cambt');
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\CambtCoin\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/CambtCoin/';
  if (isLinux) dataDir = process.env.HOME + '/.cambtcoin/';
}

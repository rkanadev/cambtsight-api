...
var genesisTXID = '00000b1d31e480973b76e617bda239365120c0b436b238765db0714e6df7b68b'; //CambtCoin
var CONCURRENCY = 5;
...
var encodedData = require('soop').load('cambtcore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('cambtcore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('cambtcore/lib/Address', {
